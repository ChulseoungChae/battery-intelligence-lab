...
ev_soh_prediction/
  ...
  outputs/
    ...
    raw/                        # 일별 압축 없음
      traj/trajectories.csv
      runs/L100_H1|L100_H50|L100_H180|L120_H180/{models,figs}/
  requirements.txt
  README.md
```
...
R1–R4는 일별 궤적(735행). R5–R7는 `row_stride=100`, `win_step=5`, `L=100`. R8은 `row_stride=60`, `win_step=5`, `L=120`, `H=180` (궤적 약 9.9만행).
