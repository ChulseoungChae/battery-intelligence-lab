...
각 실험 폴더 아래는 `traj/`, `runs/L{L}_H{H}/{models,figs}/` 구조입니다.
...
outputs/raw/traj/trajectories.csv     # 일별 집계 없음 (행 샘플)
    ...
    ├─ LOVO 검증
    └─ outputs/raw/runs/L100_H1/models/
    │
    ▼  python scripts/run_raw.py plot --L 100 --H 1
outputs/raw/runs/L100_H1/figs/
```
...
ev_soh_prediction/
  ...
  outputs/
    ...
    raw/                        # 일별 압축 없음
      traj/trajectories.csv
      runs/L100_H1|L100_H50|L100_H180|L120_H180|L120_H300/{models,figs}/
  requirements.txt
  README.md
```
...
결과는 `outputs/<exp>[/<mode>]/runs/L{L}_H{H}/` 에 저장됩니다.
---
...
| R5 | `raw` · H=1 | 100 | 1 | 11819 | **100%** | **100%** | [`runs/L100_H1/`](./outputs/raw/runs/L100_H1/) |
| R6 | `raw` · H=50 | 100 | 50 | 11780 | 99.8% | 99.8% | [`runs/L100_H50/`](./outputs/raw/runs/L100_H50/) |
| R7 | `raw` · H=180 | 100 | 180 | 11676 | 96.4% | 96.6% | [`runs/L100_H180/`](./outputs/raw/runs/L100_H180/) |
| R8 | `raw` · stride 60 | 120 | 180 | 19589 | 98.5% | 99.0% | [`runs/L120_H180/`](./outputs/raw/runs/L120_H180/) |
| R9 | `raw` · stride 60 | 120 | 300 | 19493 | 95.9% | 96.6% | [`runs/L120_H300/`](./outputs/raw/runs/L120_H300/) |

공통 데이터: 차량 4대, 기간 2022-12-15 ~ 2023-08-31, CUDA.  
R1–R4는 일별 궤적(735행). R5–R7는 `row_stride=100`, `win_step=5`, `L=100`. R8–R9는 `row_stride=60`, `win_step=5`, `L=120` (궤적 약 9.9만행).
...
- 상세: `outputs/raw/runs/L100_H1/models/lovo_metrics.csv`

#### 그래프

![R5 timeseries](./outputs/raw/runs/L100_H1/figs/lovo_pred_timeseries.png)

![R5 scatter](./outputs/raw/runs/L100_H1/figs/lovo_pred_scatter.png)

![R5 accuracy](./outputs/raw/runs/L100_H1/figs/lovo_pred_accuracy.png)
...
저장: `outputs/raw/runs/L100_H1/models/ev_L100_H1_patchtst.{pt,json}`
...
- 상세: `outputs/raw/runs/L100_H50/models/lovo_metrics.csv`
...
![R7 timeseries](./outputs/raw/runs/L100_H180/figs/lovo_pred_timeseries.png)

![R7 scatter](./outputs/raw/runs/L100_H180/figs/lovo_pred_scatter.png)

![R7 accuracy](./outputs/raw/runs/L100_H180/figs/lovo_pred_accuracy.png)
...
- 상세: `outputs/raw/runs/L100_H180/models/lovo_metrics.csv`
...
![R8 timeseries](./outputs/raw/runs/L120_H180/figs/lovo_pred_timeseries.png)

![R8 scatter](./outputs/raw/runs/L120_H180/figs/lovo_pred_scatter.png)

![R8 accuracy](./outputs/raw/runs/L120_H180/figs/lovo_pred_accuracy.png)
...
- 상세: `outputs/raw/runs/L120_H180/models/lovo_metrics.csv`
...
![R9 timeseries](./outputs/raw/runs/L120_H300/figs/lovo_pred_timeseries.png)

![R9 scatter](./outputs/raw/runs/L120_H300/figs/lovo_pred_scatter.png)

![R9 accuracy](./outputs/raw/runs/L120_H300/figs/lovo_pred_accuracy.png)
...
- 상세: `outputs/raw/runs/L120_H300/models/lovo_metrics.csv`
...
| `outputs/raw/traj/` · `runs/` | 로우 비압축 실험 |
