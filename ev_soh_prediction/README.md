...
ev_soh_prediction/
  ...
  outputs/
    ...
    models/
      ev_L14_H7_patchtst.pt
      ev_L14_H7_patchtst.json
      lovo_metrics.csv
    figs/
...
| 저장 | 경로 |
|------|------|
| 가중치 | `outputs/models/ev_L14_H7_patchtst.pt` |
| 메타 | `outputs/models/ev_L14_H7_patchtst.json` |
...
| `outputs/models/ev_L{L}_H{H}_patchtst.pt` | 모델 가중치 |
| `outputs/models/ev_L{L}_H{H}_patchtst.json` | 피처 목록·표준화 통계·모델 설정 |
